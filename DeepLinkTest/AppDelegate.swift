    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        switch UIDevice.current.userInterfaceIdiom {
            case .phone:
                ...
                let rootRegModuleNode = RouteNode(routeNodeLink: "/registration", routeNodeID: "regRootVC", routeNodeGetType: RouteNodeGetType.storyboard("Registration"), routeNodeTypes: [RouterNodeType.root])
                let regFirstStepNode = RouteNode(routeNodeLink: "/registrationFirstStep", routeNodeID: "regFirstStepVC",routeNodeGetType: RouteNodeGetType.storyboard("Registration"), routeNodeTypes: [RouterNodeType.presenter])
                let regSecondStepNode = RouteNode(routeNodeLink: "/registrationSecondStep", routeNodeID: "regSecondStepVC",routeNodeGetType: RouteNodeGetType.storyboard("Registration"), routeNodeTypes: [RouterNodeType.presenter])
                let regThirdStepNode = RouteNode(routeNodeLink: "/registrationThirdStep", routeNodeID: "regThirdStepVC",routeNodeGetType: RouteNodeGetType.storyboard("Registration"), routeNodeTypes: [RouterNodeType.presenter])
                ...
                //SWITCH ROUTE MODULE
                let switchModuleNode = RouteNode(routeNodeLink: "/switch", routeNodeID: "AuthRegSwitchVC",routeNodeGetType: RouteNodeGetType.storyboard("Switch"), routeNodeTypes: [RouterNodeType.root])
                ...
                let authModuleNode = RouteNode(routeNodeLink: "/authorization", routeNodeID: "authorizationRootVC", routeNodeGetType: RouteNodeGetType.storyboard("Authorization"),routeNodeTypes: [RouterNodeType.root])
                let authRouterModule = RouterModule(nodes: [authModuleNode], routerModuleRootNode: authModuleNode)
                //MAIN ROUTE MODULE
                let rootFirstModuleNode = RouteNode(routeNodeLink: "/firstModule", routeNodeID: "navigationTVVC",routeNodeGetType: RouteNodeGetType.storyboard("Main"), routeNodeTypes: [RouterNodeType.root])
                let dataVC = RouteNode(routeNodeLink: "/firstModule/data", routeNodeID: "dataVC",routeNodeGetType: RouteNodeGetType.storyboard("Main"), routeNodeTypes: [RouterNodeType.presenter])
                rootFirstModuleNode.addEdge(to: dataVC, transitionType: transitiontype)
                let detailVC = RouteNode(routeNodeLink: "/firstModule/data/detail", routeNodeID: "detailVC",routeNodeGetType: RouteNodeGetType.storyboard("Main"), routeNodeTypes: [RouterNodeType.data])
...
//                let testModuleNode = RouteNode(routeNodeLink: "/", routeNodeID: "testModuleRootVC", routeNodeType: RouterNodeType.root)
                let testModuleSecondNode = RouteNode(routeNodeLink: "/test", routeNodeID: "testModuleVC", routeNodeGetType: RouteNodeGetType.storyboard("Main"), routeNodeTypes: [RouterNodeType.root])
//                testModuleNode.addEdge(to: testModuleSecondNode, transitionType: transitiontype)
                ...
                //TEST TAB BAR MODULE
                let tabBarModuleRootNode = RouteNode(routeNodeLink: "/", routeNodeID: "tabBarRootVC", routeNodeGetType: RouteNodeGetType.storyboard("TabBarModuleTest"), routeNodeTypes: [RouterNodeType.root])
                let firstNVC = RouteNode(routeNodeLink: "/first", routeNodeID: "firstRootNVC", routeNodeGetType: RouteNodeGetType.storyboard("TabBarModuleTest"), routeNodeTypes: [RouterNodeType.root])
                let secondNVC = RouteNode(routeNodeLink: "/second", routeNodeID: "secondRootNVC", routeNodeGetType: RouteNodeGetType.storyboard("TabBarModuleTest"), routeNodeTypes: [RouterNodeType.root])
                let firstVC = RouteNode(routeNodeLink: "/firstVC", routeNodeID: "firstTabVC", routeNodeGetType: RouteNodeGetType.storyboard("TabBarModuleTest"), routeNodeTypes: [RouterNodeType.presenter])
                let secondVC = RouteNode(routeNodeLink: "/secondVC", routeNodeID: "secondTabVC", routeNodeGetType: RouteNodeGetType.storyboard("TabBarModuleTest"), routeNodeTypes: [RouterNodeType.presenter])
                ...
                //TEST PAGE MODULE
                let testPageModuleRootNode = RouteNode(routeNodeLink: "/pageRoot", routeNodeID: "pageRootVC", routeNodeGetType: RouteNodeGetType.storyboard("PageVCModuleTest"), routeNodeTypes: [RouterNodeType.root])
                let firstPageRootNode = RouteNode(routeNodeLink: "/firstPage", routeNodeID: "firstPageVC", routeNodeGetType: RouteNodeGetType.storyboard("PageVCModuleTest"), routeNodeTypes: [RouterNodeType.root])
                let firstPageRouterModule = RouterModule(nodes: [firstPageRootNode], routerModuleRootNode: firstPageRootNode)
                let secondPageRootNode = RouteNode(routeNodeLink: "/secondPage", routeNodeID: "secondPageVC", routeNodeGetType: RouteNodeGetType.storyboard("PageVCModuleTest"), routeNodeTypes: [RouterNodeType.root])
                let secondPageRouterModule = RouterModule(nodes: [secondPageRootNode], routerModuleRootNode: secondPageRootNode)
                let thirdPageRootNode = RouteNode(routeNodeLink: "/thirdPage", routeNodeID: "thirdPageVC", routeNodeGetType: RouteNodeGetType.storyboard("PageVCModuleTest"), routeNodeTypes: [RouterNodeType.root])
...
//                MainRouter.instance.configureModule(with: "/")
...
//                MainRouter.instance.presentModule(with: "/firstModule")
            case .pad:
                let rootNode = RouteNode(routeNodeLink: "RootNode", routeNodeID: "rootSplitVC",routeNodeGetType: RouteNodeGetType.storyboard("Main"), routeNodeTypes: [RouterNodeType.root])
                let rootFirstModuleNode = RouteNode(routeNodeLink: "/firstModule", routeNodeID: "navigationTVVC", routeNodeGetType: RouteNodeGetType.storyboard("Main"),routeNodeTypes: [RouterNodeType.root])
            let rootSecondModuleNode = RouteNode(routeNodeLink: "/secondModule", routeNodeID: "navigationDetailVC",routeNodeGetType: RouteNodeGetType.storyboard("Main"), routeNodeTypes: [RouterNodeType.root])
                let firstModuleChildNode = RouteNode(routeNodeLink: "/firstModule/data", routeNodeID: "dataVC", routeNodeGetType: RouteNodeGetType.storyboard("Main"),routeNodeTypes: [RouterNodeType.presenter])
                let secondModuleChildNode = RouteNode(routeNodeLink: "/secondModule/detail", routeNodeID: "detailVC",routeNodeGetType: RouteNodeGetType.storyboard("Main"), routeNodeTypes: [RouterNodeType.data])
